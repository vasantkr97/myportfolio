...
const Experience: React.FC<ExperienceProps> = ({ title = 'VIBE JOURNEY:' }) => {
  ...
  return (
    <div className="experience-section relative experience-container" id="experience">
      <div className="border border-dotted border-[var(--border-color)] p-3 sm:p-4 md:p-5 relative experience-content-wrapper bg-[var(--card-bg)] rounded-xl">
        <div className="size-4 bg-[var(--border-color)] absolute -top-2 -left-2"></div>

        <div className="experience-header mb-3 border-b border-[var(--border-color)] pb-3 border-dotted">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
            <Badge size="sm" className="w-fit">
              <span className="text-xs font-bold uppercase">Journey</span>
            </Badge>
            <h2 className="text-xl sm:text-2xl font-semibold experience-title leading-none">
              My Experience
            </h2>
          </div>
          <div className="flex flex-wrap gap-2">
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-[var(--bg-secondary)] border border-[var(--border-color)] rounded-md hover:bg-[var(--accent-primary)] hover:text-black hover:border-[var(--accent-primary)] transition-all duration-300 text-xs font-medium"
            >
